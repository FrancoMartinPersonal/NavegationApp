    ...
    <DrawerContentScrollView>
      ...
      {/* opciones de menú */}
          ...
          onPress={() => navigation.navigate('Tabs')}>
            ...
            <Text style={styles.menuContainerTexto}>
            <Text>
            <IconIon name="compass" size={23} color='grey' />
            </Text>
              Navegación Stack
            </Text>
          </TouchableOpacity>
          ...
          onPress={() => navigation.navigate('SettingsScreen')}>
            ...
            <Text style={styles.menuContainerTexto}>
            <Text>
            <IconIon name="cog" size={23} color='grey' />
            </Text>
              Ajustes
            </Text>
          </TouchableOpacity>
